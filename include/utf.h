...
typedef union
{
  ...
  uint8_t byte; //UNSIGNED INTEGER OF 8 BITS NAMED "byte"

}  utf8_byte_t;

typedef struct {
  utf8_byte_t bytes[4]; //THE UNION utf8_byte_t IS GIVEN 4 "bytes" (4 UNIONS IN MEMORY) OF MEMORY FOR THE STRUCT utf8_glyph_t
} utf8_glyph_t;
